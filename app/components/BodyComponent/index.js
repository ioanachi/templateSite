  ...
  <div className={`row ${styles.bodyComp}`}>
    <div className="col-sm-12 ">
      <div className="col-sm-9">
        ...
        />
        <Projects
          title="Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod dolor sit amet, consectetur adipiscing elit dolor sit amet, consectetur adipiscing elit eiusmod dolor sit amet, consectetur adipiscing elit doloreiusmod dolor sit amet, consectetur adipiscing elit dolor"
          color="rgb(28, 167, 0)"
          status=""
          reason=""
          thumbnail={pic1}
